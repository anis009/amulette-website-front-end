	...
	return (
		<div
			className={classNames(
				"flex flex-col py-2 sm:py-5 mx-2 border border-black product-card border-opacity-20 rounded-3xl text-center h-full justify-between",
				{
		...
		>
			...
			<p className="desc text-[9px] lg:text-xs text-[#1C121F] font-normal font-Poppins mt-2  px-2 sm:px-5 text-left">
