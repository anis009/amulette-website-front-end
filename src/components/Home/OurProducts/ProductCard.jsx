	...
	return (
		<div
			className={classNames(
				"flex flex-col py-2 xs:py-5 mx-2 border border-black product-card border-opacity-20 rounded-3xl text-center h-full justify-between",
				{
		...
		>
			<div
				...
				className={classNames(
					"img-wrapper px-2 py-2  mx-2 xs:mx-5 lg:px--[30px] lg:py--[15px] border border-[#F6F6F6] bg-[#F6F6F6] rounded-2xl cursor-pointer"
				)}
			>
				<div
					className={classNames(
			...
			<h3
				onClick={showModalHandler}
				className="title text-[1C121F] text-xs lg:text-lg font-semibold font-Poppins cursor-pointer text-left m-2  ml-2 xs:ml-5"
			>
				{product.title}
			</h3>
			<p className="desc text-[9px] lg:text-xs text-[#1C121F] font-normal font-Poppins mt-2  px-2 xs:px-5 text-left">
				{product.shortDescription}
			</p>
			<div className="usd-add-to-cart flex flex-row mx-2 xs:mx-5 items-center space-x-2 xs:space-x-5 mt-3.5">
