...
const MobileMenu = ({isMobileMenuOpen,setIsMobileMenuOpen}) => {
  return (
    <div className={`mobile-menu-wrapper overflow-hidden transform transition-all duration-1000 ease-in-out lg:hidden z-50 ${isMobileMenuOpen ? 'translate-y-0 opacity-100' : 'h-0 -translate-y-full opacity-0'}`}>
      <div className="mobile-menu">
        <ul className=" flex flex-col items-center justify-center space-y-12 text-lg pb-9 mt-10 relative">
